...
class Country:
    ...
    def __lt__(self, other: "Country") -> bool:
        return (
            ...
            or self.gold == other.gold and self.silver < other.silver
            or self.silver == other.silver and self.bronze < other.bronze
        )
        #if Country("KOR", 1, 2, 3) < Country("KOR", 1,2,3):
...
if __name__ == "__main__":
    ...
    for country, medal in tqdm(events, desc='Procesisng events'):
